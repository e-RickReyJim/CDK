...
class TestDataTypes:
    ...
    def test_categorical_features_are_strings(self):
        ...
        categorical_values = [
            'Normal', 'Abnormal', 'Present', 'Not Present',
            'Yes', 'No', 'Good', 'Poor'
        ]
...
class TestFeatureCount:
    ...
    def test_total_feature_count(self):
        ...
        numeric_features = 14  # age, bp, sg, albumin, sugar, bg, urea, cr, na, k, hb, pcv, wbc, rbc
...
class TestDataConsistency:
    ...
    def test_sample_patients_have_all_features(
        ...
        for patient in [sample_patient_normal, sample_patient_stage3, sample_patient_stage5]:
